...
<strong>Explanation:</strong> The in-order successor of node 1 is node 2.
</pre>
...
<strong>Explanation:</strong> There is no in-order successor of node 6, so we return <code>null</code>.
</pre>
